...
{
    public class TenantEntity : BaseEntity<long>, ITenantInfo
    {
        public TenantEntity()
        {
        }

        public TenantEntity(string id, string name, string? connectionString, string adminEmail, string? issuer = null)
        {
            Id = id;
            Identifier = id;
            Name = name;
