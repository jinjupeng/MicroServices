...
namespace LintCoder.Shared.EasyNetQ.Test
{
    public abstract class BaseUnitTest
    {
        protected static string connectionString = "host=192.168.31.190;virtualHost=/test;username=test;password=123456;timeout=60";
        protected static string[] hosts = new string[] { "192.168.31.190" };
