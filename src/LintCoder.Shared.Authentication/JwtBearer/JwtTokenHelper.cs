...
namespace LintCoder.Shared.Authentication.JwtBearer
{
    public static class JwtTokenHelper
    {
            ...
            )
        {
            ...
            return WriteToken(jwtConfig, claims, JwtTokenEnum.AccessToken);
        }
            ...
            )
        {
            ...
            return WriteToken(jwtConfig, claims, JwtTokenEnum.RefreshToken);
        }
        ...
        /// <returns></returns>
        private static JwtToken WriteToken(JwtConfig jwtConfig, Claim[] claims, JwtTokenEnum tokenType)
        {
            ...
            string audience = tokenType.Equals(JwtTokenEnum.AccessToken) ? jwtConfig.ValidAudience : jwtConfig.RefreshTokenAudience;
            int expiresencods = tokenType.Equals(JwtTokenEnum.AccessToken) ? jwtConfig.Expire : jwtConfig.RefreshTokenExpire;
